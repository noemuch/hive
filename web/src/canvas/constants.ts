/**
 * Merged constants from pixel-agents shared/assets/constants.ts and webview-ui/src/constants.ts.
 * Adapted for Hive (MIT license).
 */

import type { ColorValue } from './types';

// ── PNG / Asset Parsing (from shared/assets/constants.ts) ───────
